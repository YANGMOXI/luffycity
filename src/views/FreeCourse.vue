                    ...
                    <div class="course-info">
                        ...
                        <ul class="section-list">
                            <li v-for="(section, key) in course.section_list" :key="section.name">
                                <a href="'//'+ section.section_link">
                                    <img :src="playImg" alt="" @mouseenter="enterImg" @mouseleave="leaveImg">
...
<script>
    ...
    import play_icon_gray from "@/assets/img/play-icon-gray.svg"
    import play_icon_yellow from "@/assets/img/play-icon-yellow.svg"
    ...
    export default {
        ...
        methods: {
            ...
            enterImg(){
                this.playImg = play_icon_yellow
            },
            leaveImg(){
                this.playImg = play_icon_gray
            },
...
<style scoped>
    ...
    .course-item .section-list li {
        ...
        /*background: url("/img/play-icon-gray.svg") no-repeat left 4px;*/
        margin-bottom: 15px;
    }

    .course-item .section-list li img {
        width: 16px;
        height: 16px;
        margin-right: 6px;
    }
